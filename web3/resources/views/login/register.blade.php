                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="email" placeholder="username" class="form-control form-control-sm" id="exampleInputName" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail" class="fs-14 font-weight-bold">email</label>
                            <input type="email" placeholder="emal" class="form-control form-control-sm" id="exampleInputEmail" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" placeholder="password" class="form-control form-control-sm" id="exampleInputPassword2">
                        </div>
